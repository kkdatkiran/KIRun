...
<tr><td style="padding:10px">
	...
	<tr><td style="background-color: #FFFFFF;padding-top:20px" align="center">
		<h1 style="font-size: 25px; line-height: 35px; font-weight: bold; color: #064a5a">This is a test email</h1>
		<div style="width: 100%; font-size: 15px; color: #000; padding: 30px 45px; box-sizing: border-box; min-height: 300px; text-align: justify">
			Hi,<br /> <br />I am testing this to see if the service is working or not... here is a value from template resolution "${param}". If images are being displayed properly, inline attachments are working.
		</div>
	</td></tr>
