...
<tr><td style="padding:10px">
	...
	<tr><td style="background-color: #FFFFFF;padding-top:20px" align="center">
		<h1 style="font-size: 25px; line-height: 35px; font-weight: bold; color: #a85b37">Reset password for KIRun</h1>
		<div style="width: 100%; font-size: 15px; color: #888; padding: 30px 45px; box-sizing: border-box; min-height: 300px; text-align: justify">
			...
			<a href="${urlPrefix}/resetPassword/${user.email}/${user.resetPasswordString}" style="text-decoration:none;line-height:100%;background:#a85b37;color:white;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:15px;font-weight:normal;text-transform:none;margin:0px;padding: 10px 30px;border-radius:3px">Reset Password</a>
			</div>
			If the above button don't work please copy the link below and open in a browser.
			<span style="color: #a85b37;font-weight:bold; display:block;padding:10px;text-align:center">${urlPrefix}/resetPassword/${user.email}/${user.resetPasswordString}</span>	
		</div>
	</td></tr>
